  ...
  return (
    <header className="relative w-full border-b bg-orange-50 px-4 sm:px-6 py-3 flex items-center justify-between text-gray-500">
      ...
      <div className="hidden md:flex flex-1 mx-6 relative">
        <div className="flex items-center w-full max-w-xl border border-orange-50 rounded-full px-4 py-2 bg-orange-200 shadow-sm">
          ...
          <input
            ...
            className="flex-1 px-3 py-1 outline-none text-gray-900 font-heading"
            value={searchTerm}
      ...
      <div className="flex items-center gap-3 sm:gap-4">
        <Dropdown
          button={
            <div className="md:hidden px-2 py-2 flex items-center justify-center bg-orange-200 rounded-full hover:bg-orange-50 transition">
              <MagnifyingGlassIcon className="w-4 h-4 lg:w-5 lg:h-5 text-orange-900" />
            </div>
          }
        >
...
function CartDropdown() {
  ...
  return (
    <Dropdown
      ...
      width="w-[21rem]"
      button={
        <div className="relative flex items-center gap-2 bg-orange-200 text-orange-900 px-2 sm:px-4 py-2 rounded-full hover:bg-orange-200 transition cursor-pointer">
          <div className="relative">
            <ShoppingCartIcon className="w-4 h-4 lg:w-5 lg:h-5" />
            {cart.length > 0 && (
              <span className="absolute -top-2 -right-3 bg-orange-600 text-white text-[9px] font-extrabold rounded-full w-3.5 h-3.5 flex items-center justify-center">
                {cart.length}
              </span>
            )}
          </div>
            ...
            <button
              ...
              className={`mt-6 w-full py-3 rounded-full font-medium transition ${
                loading
                  ...
                  : "bg-gray-500 hover:bg-orange-600 text-white cursor-pointer"
              }`}
            >
              {loading ? (
